...
@Injectable()
export class ActivityMatasaService {
  private bucketName = 'seeme-7a462.appspot.com';

  constructor(
    @InjectModel('Matasa') private boutiqueModel: Model<Article>,
    @InjectModel('AnnonceMatasa') private annonceModel: Model<Annonce>,
    @InjectModel('OrderMatasa') private orderModel: Model<Order>,
