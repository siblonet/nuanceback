...
@Controller('BefreeAccessclosing')
export class BefreePersonController {
  ...
  @Get("/:id")
  async getMe(@Param('id') id: string): Promise<BefreeUser> {
  ...
  @Put('/:id')
  async updateUser(@Param('id') id: string, @Body() triumphUser: BefreeUser): Promise<BefreeUser> {
